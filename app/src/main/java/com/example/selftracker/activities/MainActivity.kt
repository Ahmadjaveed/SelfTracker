...
class MainActivity : AppCompatActivity() {
    ...
    private fun initializeViews() {
        ...
        bottomNavigation.add(CurvedBottomNavigation.Model(ID_HABITS, "", R.drawable.ic_habits_nav))
        bottomNavigation.add(CurvedBottomNavigation.Model(ID_GOALS, "", R.drawable.ic_rocket_nav))
        bottomNavigation.add(CurvedBottomNavigation.Model(ID_PROGRESS, "", R.drawable.ic_progress_nav))
